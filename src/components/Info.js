...
function Info({data}) {
    ...
    return (
        <div style={width > 980 ? {height: "100vh", 
                    display:"flex", 
                    flexDirection:"column", 
                    justifyContent:"space-between",
                    borderRight:"1px solid black", position:"fixed", left:"0", width:"6%"}
                    : {
                    display:"flex", 
                    justifyContent:"space-between",
            ...
            <Popover placement="bottom">
                <PopoverTrigger>
                    <img style={{marginTop:"0.2vh", marginBottom:"0.2vh"}} 
                            size={width > 980 ? "md" : "sm"} 
                            name='' src={data && data[0].photoURL} 
                    />
                </PopoverTrigger>
                <Portal>
                    <PopoverContent>
